  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto pb-24 px-4">
      ...
      <div className="relative p-8 md:p-12 bg-[#050505] rounded-sm shadow-2xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-16 py-12 px-8 md:px-16">
            ...
            <div key={rowIndex} className="relative group">
              ...
              {rowIndex === 0 && (
                <img 
                  ...
                  className="absolute -bottom-1 right-4 w-32 md:w-40 object-contain opacity-90 pointer-events-none z-20 transform rotate-1 drop-shadow-lg"
                  alt="Worn Journals"
                />
              )}
              ...
              {rowIndex % 2 !== 0 && (
                <img 
                  ...
                  className="absolute -bottom-2 left-8 w-20 h-20 object-contain opacity-60 pointer-events-none z-20"
                  alt="Wires"
                />
              )}
