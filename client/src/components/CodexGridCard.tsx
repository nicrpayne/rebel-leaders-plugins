...
export default function CodexGridCard({ entry, isActive, onClick }: CodexGridCardProps) {
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-end pb-3 px-4">
        {/* Title positioned to align with the tape label */}
        <div className="transform translate-y-1">
            <h4 className={cn(
              "font-mono text-xs leading-tight text-[#2a2a2a] font-bold tracking-tight uppercase truncate opacity-80 mix-blend-multiply pl-12 pr-2",
            )}>
              {entry.title}
            </h4>
             <span className="font-handwriting text-[10px] text-[#2a2a2a] opacity-70 pl-12 block -mt-0.5">
