...
export default function ReaderDrawer({
  ...
  // Initialize checklist based on protocol steps (mocking steps for now as they aren't in schema yet)
  // In a real app, we'd parse the script or have a dedicated steps array.
  // For this demo, we'll split the script by newlines to create "steps".
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      {/* Drawer Panel */}
      <div className="relative w-full md:max-w-2xl bg-[#080808] border-l border-amber-500/20 h-full shadow-[-20px_0_50px_rgba(0,0,0,0.8)] flex flex-col animate-in slide-in-from-right duration-300">
        
        {/* Header - Tape Deck Style */}
        <div className="p-6 md:p-8 border-b border-[#222] bg-[#0c0c0c] relative overflow-hidden flex-shrink-0">
          {/* Decorative Holes */}
          <div className="absolute top-2 left-0 right-0 flex justify-between px-4 opacity-20 pointer-events-none">
             {[...Array(20)].map((_, i) => (
