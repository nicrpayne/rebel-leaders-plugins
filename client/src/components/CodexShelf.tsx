    ...
    <div className="relative w-full overflow-hidden rounded-sm">
      ...
      <div className="relative z-[2] flex flex-col">
        ...
        <div className="relative pl-0 pr-4 md:pr-5 lg:pr-6 pt-0">
          <div
            ref={scrollRefTop}
            className="flex items-end gap-0 overflow-x-auto pb-0 pt-0 scrollbar-thin scrollbar-thumb-amber-900/30 scrollbar-track-transparent scroll-smooth h-[250px] md:h-[290px] lg:h-[330px]"
          >
